...
final class DataBarrelServiceImpl implements Closeable, DataBarrelService {
    ...
    private final Map<String, JedisCommandsProvider<?>> jedisClientMap;
    ...
    public DataBarrelServiceImpl(
            ...
            @NotNull Map<String, JedisCommandsProvider<?>> jedisClientMap,
    ...
    public JedisCommandsProvider<?> getJedisProvider(String name) {
